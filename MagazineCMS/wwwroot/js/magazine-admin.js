...
function loadDataTable() {
    dataTable = $('#magazine-table').DataTable({
        "ajax": { url: '/admin/magazine/getall' },
        "columns": [
    ...
    $(document).ready(function () {
        $('#SemesterId').change(function () {
            ...
            $.ajax({
                url: '/admin/magazine/getsemester',
                type: 'GET',
...
function download(magazineId) {
    window.location.href = '/admin/magazine/downloadalldocuments?magazineId=' + magazineId;
}


function updateMagazine(magazineId) {
    console.log(magazineId);
    location.href = "https://localhost:7276/Admin/Magazine/updateMagazine/" + magazineId;
}
...
function deleteMagazine(magazineId) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch(`/admin/magazine/deleteMagazine/${magazineId}`, {
                method: 'DELETE',
                headers: {
