...
namespace MagazineCMS.DataAccess.Migrations
{
    ...
    [Migration("20240419020915_fix comment")]
            ...
            modelBuilder.Entity("MagazineCMS.Models.Contribution", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MagazineId = 1,
                            Status = "Pending",
                            SubmissionDate = new DateTime(2024, 4, 19, 9, 9, 14, 825, DateTimeKind.Local).AddTicks(6780),
            ...
            modelBuilder.Entity("MagazineCMS.Models.Magazine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 26, 9, 9, 14, 825, DateTimeKind.Local).AddTicks(6758),
                            FacultyId = 2,
                            Name = "Computing Magazine - Spring 2024",
                            SemesterId = 1,
                            StartDate = new DateTime(2024, 4, 12, 9, 9, 14, 825, DateTimeKind.Local).AddTicks(6744)
                        },
                        new
                        {
                            Id = 2,
                            Description = "Welcome",
                            EndDate = new DateTime(2024, 4, 26, 9, 9, 14, 825, DateTimeKind.Local).AddTicks(6761),
                            FacultyId = 3,
                            Name = "Business Magazine - Spring 2024",
                            SemesterId = 1,
                            StartDate = new DateTime(2024, 4, 12, 9, 9, 14, 825, DateTimeKind.Local).AddTicks(6760)
                        });
                });
