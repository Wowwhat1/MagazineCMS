...
namespace MagazineCMS.DataAccess.Migrations
{
    ...
    [Migration("20240418092121_AddIsAnonymousFlagInCommentTable")]
    partial class AddIsAnonymousFlagInCommentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MagazineCMS.Models.Contribution", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MagazineId = 1,
                            Status = "Pending",
                            SubmissionDate = new DateTime(2024, 4, 18, 16, 21, 20, 293, DateTimeKind.Local).AddTicks(4558),
            ...
            modelBuilder.Entity("MagazineCMS.Models.Magazine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 25, 16, 21, 20, 293, DateTimeKind.Local).AddTicks(4533),
                            FacultyId = 2,
                            Name = "Computing Magazine - Spring 2024",
                            SemesterId = 1,
                            StartDate = new DateTime(2024, 4, 11, 16, 21, 20, 293, DateTimeKind.Local).AddTicks(4520)
                        },
                        new
                        {
                            Id = 2,
                            Description = "Welcome",
                            EndDate = new DateTime(2024, 4, 25, 16, 21, 20, 293, DateTimeKind.Local).AddTicks(4536),
                            FacultyId = 3,
                            Name = "Business Magazine - Spring 2024",
                            SemesterId = 1,
                            StartDate = new DateTime(2024, 4, 11, 16, 21, 20, 293, DateTimeKind.Local).AddTicks(4535)
                        });
                });
