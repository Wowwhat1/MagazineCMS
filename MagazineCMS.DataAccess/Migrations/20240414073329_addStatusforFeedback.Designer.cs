...
namespace MagazineCMS.DataAccess.Migrations
{
    ...
    [Migration("20240414073329_addStatusforFeedback")]
    partial class addStatusforFeedback
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MagazineCMS.Models.Contribution", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MagazineId = 1,
                            Status = "Pending",
                            SubmissionDate = new DateTime(2024, 4, 14, 14, 33, 28, 372, DateTimeKind.Local).AddTicks(1349),
            ...
            modelBuilder.Entity("MagazineCMS.Models.Magazine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 21, 14, 33, 28, 372, DateTimeKind.Local).AddTicks(1327),
                            FacultyId = 2,
                            Name = "Computing Magazine - Spring 2024",
                            SemesterId = 1,
                            StartDate = new DateTime(2024, 4, 7, 14, 33, 28, 372, DateTimeKind.Local).AddTicks(1309)
                        },
                        new
                        {
                            Id = 2,
                            Description = "Welcome",
                            EndDate = new DateTime(2024, 4, 21, 14, 33, 28, 372, DateTimeKind.Local).AddTicks(1330),
                            FacultyId = 3,
                            Name = "Business Magazine - Spring 2024",
                            SemesterId = 1,
                            StartDate = new DateTime(2024, 4, 7, 14, 33, 28, 372, DateTimeKind.Local).AddTicks(1329)
                        });
                });
