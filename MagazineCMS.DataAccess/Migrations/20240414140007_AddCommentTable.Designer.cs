...
namespace MagazineCMS.DataAccess.Migrations
{
    ...
    [Migration("20240414140007_AddCommentTable")]
            ...
            modelBuilder.Entity("MagazineCMS.Models.Contribution", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MagazineId = 1,
                            Status = "Pending",
                            SubmissionDate = new DateTime(2024, 4, 14, 21, 0, 7, 101, DateTimeKind.Local).AddTicks(740),
            ...
            modelBuilder.Entity("MagazineCMS.Models.Magazine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 21, 21, 0, 7, 101, DateTimeKind.Local).AddTicks(713),
                            FacultyId = 2,
                            Name = "Computing Magazine - Spring 2024",
                            SemesterId = 1,
                            StartDate = new DateTime(2024, 4, 7, 21, 0, 7, 101, DateTimeKind.Local).AddTicks(695)
                        },
                        new
                        {
                            Id = 2,
                            Description = "Welcome",
                            EndDate = new DateTime(2024, 4, 21, 21, 0, 7, 101, DateTimeKind.Local).AddTicks(716),
                            FacultyId = 3,
                            Name = "Business Magazine - Spring 2024",
                            SemesterId = 1,
                            StartDate = new DateTime(2024, 4, 7, 21, 0, 7, 101, DateTimeKind.Local).AddTicks(715)
                        });
                });
